        ...
        <div 
          className={`group relative p-6 rounded-2xl transition-all duration-500 animate-fade-in-up stagger-1 opacity-0 glass-card
            ${activePanel === "employee" 
              ? "ring-2 ring-primary/50 shadow-2xl glow-gold" 
              : ""
            }`}
        >
          {/* Subtle inner glow */}
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="pl-10 h-10 bg-background/40 backdrop-blur-sm border-border/30 rounded-xl focus:bg-background/60 focus:border-primary/50 transition-all" 
                    value={email} 
