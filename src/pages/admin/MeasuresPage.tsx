...
function MeasureFormDialog({ open, onClose, initial }: MeasureFormProps) {
  ...
  // All competencies from all role profiles for linking
        ...
        <div className="space-y-4 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              placeholder="z.B. AI in Legal Practice Seminar"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                placeholder="z.B. Bucerius Law School"
              />
            </div>
            <div className="space-y-1.5">
              <Label>Kosten (€)</Label>
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="space-y-1.5">
              ...
              <Input
                ...
                onChange={(e) => setForm((f) => ({ ...f, duration_hours: Number(e.target.value) || undefined }))}
              />
            </div>
            <div className="space-y-1.5">
              <Label>Start</Label>
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) => setForm((f) => ({ ...f, assigned_team_id: v === "none" ? null : v }))}
            >
                ...
                return (
                  <button
                    ...
                    onClick={() =>
                      setForm((f) => ({
                        ...f,
                        linked_competency_ids: selected
                          ? f.linked_competency_ids?.filter((id) => id !== c.id)
                          : [...(f.linked_competency_ids || []), c.id],
                      }))
                    }
                        ...
                        <div>
                          ...
                          {m.duration_hours && (
                            <span className="text-xs text-muted-foreground ml-2">
                              {m.duration_hours} Std.
                            </span>
                          )}
                        </div>
                      </TableCell>
                      <TableCell className="text-sm text-muted-foreground py-3">
                        {typeLabel(m.measure_type)}
                      </TableCell>
                      <TableCell className="text-sm text-muted-foreground py-3">
                        {m.provider || "—"}
                      </TableCell>
                        ...
                        <div className="flex flex-wrap gap-1 max-w-[180px]">
                          ...
                          {(m.linked_competency_ids?.length || 0) > 2 && (
                            <Badge variant="outline" className="text-[10px]">
                              +{m.linked_competency_ids.length - 2}
                            </Badge>
                          )}
                        </div>
                      </TableCell>
                      <TableCell className="py-3">
                        <div className="flex gap-1">
                          <Button
                            ...
                            size="icon"
                            className="h-7 w-7"
                            onClick={() => { setEditMeasure(m); setFormOpen(true); }}
                          >
